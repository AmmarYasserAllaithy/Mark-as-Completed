/*
 * Forked from
 * https://github.com/apache/npanday/blob/trunk/components/dotnet-registry/src/main/java/npanday/registry/impl/WinRegistry.java
 */
...
public class WinRegistry {
    ...
    public static final int REG_ACCESS_DENIED = 5;
    ...
    private static int deleteValue(Preferences root, int hkey, String key, String value)
        ...
        if (handles[1] != REG_SUCCESS) return handles[1];  // can be REG_NOTFOUND, REG_ACCESS_DENIED
    ...
    private static int deleteKey(Preferences root, int hkey, String key)
            throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        return (Integer) regDeleteKey.invoke(root, new Object[]{hkey, toCstr(key)});
        // can REG_NOTFOUND, REG_ACCESS_DENIED, REG_SUCCESS
    }
